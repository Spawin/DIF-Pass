...
abstract class AppLocalizations {
  ...
  /// No description provided for @eventsMoreActions.
  ///
  /// In en, this message translates to:
  /// **'More actions'**
  String get eventsMoreActions;
  ...
  /// No description provided for @eventsCheckInAction.
  ///
  /// In en, this message translates to:
  /// **'Check-in'**
  String get eventsCheckInAction;
  ...
  /// No description provided for @csvImportPreviewMoreRows.
  ///
  /// In en, this message translates to:
  /// **'+ {count} more rows'**
  ...
  /// No description provided for @ticketPreviewGeneratedByLabel.
  ///
  /// In en, this message translates to:
  /// **'Generated by'**
  String get ticketPreviewGeneratedByLabel;
